...
local base = 'Interface\\Addons\\GoAgainAH\\UI\\Textures\\'
...
-------------------------------------------------------------------------------]]
local FrameBackdrop = {
	bgFile = base .. 'ui-background-rock',
...
local function Constructor()
	...
	local base = 'Interface\\Addons\\DragonflightUI\\UI\\Textures\\'
	local titlebg_l = frame:CreateTexture(nil, "OVERLAY")
	titlebg_l:SetTexture(base .. 'professionbackgroundart') -- Interface\\DialogFrame\\UI-DialogBox-Header
	...
	titlebg_r:SetTexture(base .. 'professionbackgroundart') -- Interface\\DialogFrame\\UI-DialogBox-Header
